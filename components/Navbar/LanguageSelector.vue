<template>
  <div
    class="inline-block w-44 py-3 transition-all duration-200 hover:bg-white hover:text-black rounded-full ml-3 cursor-pointer"
    ...
    <div class="flex justify-center items-center relative">
      ...
      <div id="languages-dropdown" class="absolute" v-show="dropdown.languages">
        <div
          ...
          :key="lang.code"
          :value="lang.code"
          class="text-center py-3 bg-black text-white hover:bg-white hover:text-black transition-all duration-200"
          @click="dropdown.languages = false"
        >
          <nuxt-link :to="localePath('index', lang.code)">{{ lang.name }}</nuxt-link>
        </div>
      </div>
